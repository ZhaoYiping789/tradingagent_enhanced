...
class ConditionalLogic:
    ...
    def should_continue_visualizer(self, state: AgentState):
        """Determine if visualizer analysis should continue."""
        messages = state["messages"]
        last_message = messages[-1]
        if hasattr(last_message, 'tool_calls') and last_message.tool_calls:
            return "tools_visualizer"
        return "Msg Clear Visualizer"
